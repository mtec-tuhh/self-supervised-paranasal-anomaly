...
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_l1_MF_0 \
name=finetune_LARS_residual_net_bs_128_l1_MF_0_10 hydra.job.name=finetune_LARS_residual_net_bs_128_l1_MF_0_10  \
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_l1_MF_0 \
name=finetune_LARS_residual_net_bs_128_l1_MF_0_80 hydra.job.name=finetune_LARS_residual_net_bs_128_l1_MF_0_80  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_l1_MF_0 \
name=finetune_LARS_residual_net_bs_128_l1_MF_0_60 hydra.job.name=finetune_LARS_residual_net_bs_128_l1_MF_0_60  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_l1_MF_0 \
name=finetune_LARS_residual_net_bs_128_l1_MF_0_40 hydra.job.name=finetune_LARS_residual_net_bs_128_l1_MF_0_40  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_l1_MF_0 \
name=finetune_LARS_residual_net_bs_128_l1_MF_0_20 hydra.job.name=finetune_LARS_residual_net_bs_128_l1_MF_0_20  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_l1_MF_0 \
name=finetune_LARS_residual_net_bs_128_l1_MF_0_100 hydra.job.name=finetune_LARS_residual_net_bs_128_l1_MF_0_100  \
+onlyEval=False test_after_training=True 
