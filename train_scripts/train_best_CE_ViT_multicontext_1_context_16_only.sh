...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=1 HYDRA_FULL_ERROR=1 python3 run.py  \
datamodule=crop_size_35_std_factor_1.yaml model=multicontext_3D_ViT_context_16_only.yaml \
...
name=multicontext_3D_ViT_context_16_only_sp_15 hydra.job.name=multicontext_3D_ViT_context_16_only_sp_15 \
...
name=multicontext_3D_ViT_context_16_only_sp_10 hydra.job.name=multicontext_3D_ViT_context_16_only_sp_10 \
+onlyEval=False test_after_training=True logger=wandb enable_convnet_model=True \
