...
datamodule=crop_size_35_std_factor_1.yaml model=multicontext_3D_ViT_context_16.yaml \
...
name=multicontext_3D_ViT_context_16_sp_15 hydra.job.name=multicontext_3D_ViT_context_16_sp_15 \
...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 HYDRA_FULL_ERROR=1 python3 run.py  \
datamodule=crop_size_35_std_factor_1.yaml model=multicontext_3D_ViT_context_16_sp_15.yaml \
...
datamodule=crop_size_35_std_factor_1.yaml model=multicontext_3D_ViT_context_16.yaml \
+seed=100 trainer.max_epochs=100 current_fold=1 \
+enable_logger=True hydra.job.chdir=False datamodule.cfg.batch_size=16 datamodule.cfg.samples_pee_patent=10 \
name=multicontext_3D_ViT_context_16_sp_10 hydra.job.name=multicontext_3D_ViT_context_16_sp_10 \
+onlyEval=False test_after_training=True logger=wandb enable_convnet_model=True \
...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 HYDRA_FULL_ERROR=1 python3 run.py  \
datamodule=crop_size_35_std_factor_1.yaml model=multicontext_3D_ViT_context_16_sp_10.yaml \
+seed=100 trainer.max_epochs=100 current_fold=2 \
+enable_logger=True hydra.job.chdir=False datamodule.cfg.batch_size=16 datamodule.cfg.samples_pee_patent=10 \
name=multicontext_3D_ViT_context_16_sp_10 hydra.job.name=multicontext_3D_ViT_context_16_sp_10 \
+onlyEval=False test_after_training=True logger=wandb enable_convnet_model=True \
