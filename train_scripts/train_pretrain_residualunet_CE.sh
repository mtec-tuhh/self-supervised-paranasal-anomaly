...
name=pretrain_LARS_residual_net_bs_128_ce_MF_0 hydra.job.name=pretrain_LARS_residual_net_bs_128_ce_MF_0  \
...
datamodule.cfg.samples_per_patient=1  \
name=pretrain_LARS_residual_net_bs_128_ce_MF_3 hydra.job.name=pretrain_LARS_residual_net_bs_128_ce_MF_3  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
name=pretrain_LARS_residual_net_bs_128_ce_MF_5 hydra.job.name=pretrain_LARS_residual_net_bs_128_ce_MF_5  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
name=pretrain_LARS_residual_net_bs_128_ce_MF_7 hydra.job.name=pretrain_LARS_residual_net_bs_128_ce_MF_7  \
+onlyEval=False test_after_training=True 
