...
datamodule=crop_size_35_std_factor_1.yaml model=multicontext_3D_ViT_context_8.yaml \
...
name=multicontext_3D_ViT_context_8_sp_15 hydra.job.name=multicontext_3D_ViT_context_8_sp_15 \
...
name=multicontext_3D_ViT_context_8_sp_10 hydra.job.name=multicontext_3D_ViT_context_8_sp_10 \
+onlyEval=False test_after_training=True logger=wandb enable_convnet_model=True \
