...
name=no_pretrain_10 hydra.job.name=no_pretrain_10  \
...
datamodule.cfg.batch_size=16  \
datamodule.cfg.samples_per_patient=1  \
name=no_pretrain_80 hydra.job.name=no_pretrain_80  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.batch_size=16  \
datamodule.cfg.samples_per_patient=1  \
name=no_pretrain_60 hydra.job.name=no_pretrain_60  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.batch_size=16  \
datamodule.cfg.samples_per_patient=1  \
name=no_pretrain_40 hydra.job.name=no_pretrain_40  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.batch_size=16  \
datamodule.cfg.samples_per_patient=1  \
name=no_pretrain_20 hydra.job.name=no_pretrain_20  \
+onlyEval=False test_after_training=True 
...
CUDA_VISIBLE_DEVICES=1 HYDRA_FULL_ERROR=1 python3 run.py  \
datamodule=crop_size_65_std_factor_1_Classification_Nature_100.yaml  model=my_resUnet_3D_simclr.yaml  \
+seed=100 trainer.max_epochs=100 total_folds=5  \
trainer.limit_train_batches=1.0 \
+enable_logger=False model.cfg.classify=True \
hydra.job.chdir=False  \
datamodule.cfg.batch_size=16  \
datamodule.cfg.samples_per_patient=1  \
name=no_pretrain_100 hydra.job.name=no_pretrain_100  \
+onlyEval=False test_after_training=True 
