...
datamodule=crop_size_40_std_factor_1.yaml model=trans_resnet_3D_34.yaml \
...
model.cfg.features_to_include=[1,0,1] \
name=midlrebuttal_contranet-m-101-cc-45\
model.cfg.enable_transformer=True \
hydra.job.name=midlrebuttal_contranet-m-101-cc-45 \
