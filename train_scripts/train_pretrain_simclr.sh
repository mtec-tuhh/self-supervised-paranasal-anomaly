...
datamodule=crop_size_65_std_factor_1_Nature_simclr_pretraining.yaml  model=my_resUnet_3D_simclr.yaml  \
...
name=pretrain_simclr_t_007 hydra.job.name=pretrain_simclr_t_007 \
