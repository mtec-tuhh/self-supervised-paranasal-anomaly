...
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_l2_MF_3 \
name=finetune_new_residual_net_bs_128_l2_MF_3_10 hydra.job.name=finetune_new_residual_net_bs_128_l2_MF_3_10  \
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_l2_MF_3 \
name=finetune_new_residual_net_bs_128_l2_MF_3_80 hydra.job.name=finetune_new_residual_net_bs_128_l2_MF_3_80  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_l2_MF_3 \
name=finetune_new_residual_net_bs_128_l2_MF_3_60 hydra.job.name=finetune_new_residual_net_bs_128_l2_MF_3_60  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_l2_MF_3 \
name=finetune_new_residual_net_bs_128_l2_MF_3_40 hydra.job.name=finetune_new_residual_net_bs_128_l2_MF_3_40  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_l2_MF_3 \
name=finetune_new_residual_net_bs_128_l2_MF_3_20 hydra.job.name=finetune_new_residual_net_bs_128_l2_MF_3_20  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_l2_MF_3 \
name=finetune_new_residual_net_bs_128_l2_MF_3_100 hydra.job.name=finetune_new_residual_net_bs_128_l2_MF_3_100  \
+onlyEval=False test_after_training=True 
