...
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_ce_MF_7 \
name=finetune_new_residual_net_bs_128_ce_MF_7_10 hydra.job.name=finetune_new_residual_net_bs_128_ce_MF_7_10  \
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_ce_MF_7 \
name=finetune_new_residual_net_bs_128_ce_MF_7_80 hydra.job.name=finetune_new_residual_net_bs_128_ce_MF_7_80  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_ce_MF_7 \
name=finetune_new_residual_net_bs_128_ce_MF_7_60 hydra.job.name=finetune_new_residual_net_bs_128_ce_MF_7_60  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_ce_MF_7 \
name=finetune_new_residual_net_bs_128_ce_MF_7_40 hydra.job.name=finetune_new_residual_net_bs_128_ce_MF_7_40  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_ce_MF_7 \
name=finetune_new_residual_net_bs_128_ce_MF_7_20 hydra.job.name=finetune_new_residual_net_bs_128_ce_MF_7_20  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_residual_net_bs_128_ce_MF_7 \
name=finetune_new_residual_net_bs_128_ce_MF_7_100 hydra.job.name=finetune_new_residual_net_bs_128_ce_MF_7_100  \
+onlyEval=False test_after_training=True 
