...
+load_checkpoint_for_training=pretrain_LARS_AE_3D_60 \
name=ae_60_bs_128_ce_MF_5_10 hydra.job.name=ae_60_bs_128_ce_MF_5_10  \
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_AE_3D_60 \
name=ae_60_bs_128_ce_MF_5_80 hydra.job.name=ae_60_bs_128_ce_MF_5_80  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_AE_3D_60 \
name=ae_60_bs_128_ce_MF_5_60 hydra.job.name=ae_60_bs_128_ce_MF_5_60  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_AE_3D_60 \
name=ae_60_bs_128_ce_MF_5_40 hydra.job.name=ae_60_bs_128_ce_MF_5_40  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_AE_3D_60 \
name=ae_60_bs_128_ce_MF_5_20 hydra.job.name=ae_60_bs_128_ce_MF_5_20  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_LARS_AE_3D_60 \
name=ae_60_bs_128_ce_MF_5_100 hydra.job.name=ae_60_bs_128_ce_MF_5_100  \
+onlyEval=False test_after_training=True 
