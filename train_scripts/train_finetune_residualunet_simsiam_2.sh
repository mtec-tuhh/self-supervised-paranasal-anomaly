...
name=finetune_new_residual_net_siamsim_80 hydra.job.name=finetune_new_residual_net_siamsim_80  \
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_siamsim \
name=finetune_new_residual_net_siamsim_60 hydra.job.name=finetune_new_residual_net_siamsim_60  \
+onlyEval=False test_after_training=True 
...
datamodule.cfg.samples_per_patient=1  \
+load_checkpoint_for_training=pretrain_siamsim \
name=finetune_new_residual_net_siamsim_40 hydra.job.name=finetune_new_residual_net_siamsim_40  \
+onlyEval=False test_after_training=True 
