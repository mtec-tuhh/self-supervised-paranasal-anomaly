...
class ResUNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.decocer_layer_3 = Up3d(in_channels=block_inplanes[2],out_channels=block_inplanes[1],single_upsampling= True )
        self.decocer_layer_2 = Up3d(in_channels=block_inplanes[1],out_channels=block_inplanes[0],single_upsampling= True )
        self.decocer_layer_1 = Up3d(in_channels=block_inplanes[0],out_channels=block_inplanes[0],single_upsampling= True )
        self.up=  nn.Upsample(scale_factor=2,mode="trilinear")
    ...
    def forward(self, x):
        ...
        x6 =  self.decocer_layer_4(x6,None)
        x6 =  self.decocer_layer_3(x6,None)
        x6 =  self.decocer_layer_2(x6,None)
        x6 =  self.decocer_layer_1(x6,None)
        x6 =  self.decocer_layer_1(self.up(x6),None)
        dx = self.deconv1(x6)
