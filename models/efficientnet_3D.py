...
class EfficientNetClassifer(pl.LightningModule):

    def __init__(self,cfg,prefix=None):
        super(EfficientNetClassifer, self).__init__()
        

        self.cfg = cfg
        # Model 
        self.model = EfficientNet3D.from_name(self.cfg.model_name, override_params={'num_classes': 2}, in_channels=1)
